        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="<?= ($current_page == 'transaksi.php') ? 'active' : '' ?>"><a href="transaksi.php"><i class="glyphicon glyphicon-shopping-cart"></i> Transaksi</a></li>
                    <li class="<?= ($current_page == 'laporan.php') ? 'active' : '' ?>"><a href="laporan.php"><i class="glyphicon glyphicon-list-alt"></i> Laporan</a></li>
                    <li class="dropdown <?= ($current_page == 'paket.php' || $current_page == 'ganti_password.php') ? 'active' : '' ?>">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="pengaturan_rekening.php"><i class="glyphicon glyphicon-credit-card"></i> Nomor Rekening</a></li>
                            <li class="<?= ($current_page == 'paket.php') ? 'active' : '' ?>"><a href="paket.php"><i class="glyphicon glyphicon-usd"></i> Pengaturan Harga</a></li>
